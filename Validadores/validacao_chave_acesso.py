...
def validar_chave_acesso(chave_acesso):
    ...
    if len(chave_acesso_valida) != 7:
        ...
        console.print("\nChave de Acesso deve conter 7 dígitos", style="bold yellow")
        console.print("\nNão utilize espaços ou pontuações", style="bold yellow")
        sleep(1.5)
        limpar_tela()
        return False
    ...
    if not chave_acesso_valida[0:3].isalpha():
        console.print("\nChave de Acesso INVÁLIDA", style="bold red")
        console.print("\nOs três primeiros dígitos devem ser LETRAS", style="bold yellow")
        sleep(1.5)
        limpar_tela()
        return False
    ...
    if not chave_acesso_valida[3:7].isdigit():
        console.print("\nChave de Acesso INVÁLIDA", style="bold red")
        console.print("\nOs quatro últimos dígitos devem ser NÚMEROS", style="bold yellow")
        sleep(1.5)
        limpar_tela()
        return False
